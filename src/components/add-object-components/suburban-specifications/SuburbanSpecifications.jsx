...
import './suburban-specifications.css'

const SuburbanSpecifications = props => {
    ...
    const {
        ...
        roofSearch, waterSearch, gasSearch, heatingSearch, electroSearch, directionSearch } = searchFieldOption
            ...
            <div className="suburban-specifications">
                ...
                <div className="specifications__inf">
                    ...
                    <FormInput margin={'15px 0 0'} labelValue={'Готовность в %'} width={'100%'}
                               ...
                               onChange={e => setState({
                                   ...state,
                                   building_percent: e.target.value
                               })}
                    />
                    <p>Кол-во уровней</p>
...
export default connect(mapStateToProps)(SuburbanSpecifications)